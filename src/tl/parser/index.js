...
return result;
  ...
  [3413112872, function() {
const result = { _: 'savedReactionTag' };
result.flags = this.int();
result.reaction = this.predicate();
if (result.flags & 1) result.title = this.string();
result.count = this.int();
return result;
  ...
  [2291882479, function() {
const result = { _: 'messages.savedReactionTagsNotModified' };
return result;
  }],
  [844731658, function() {
const result = { _: 'messages.savedReactionTags' };
result.tags = this.vector(this.predicate, false);
result.hash = this.long();
return result;
  }],
  [969307186, function() {
const result = { _: 'updateSavedReactionTags' };
return result;
  }],
  [1001931436, function() {
const result = { _: 'outboxReadDate' };
result.date = this.int();
return result;
  }],
  [3422726765, function() {
const result = { _: 'messageActionBoostApply' };
result.boosts = this.int();
return result;
  }],
  [1188577451, function() {
const result = { _: 'channelAdminLogEventActionChangeEmojiStickerSet' };
result.prev_stickerset = this.predicate();
result.new_stickerset = this.predicate();
return result;
  }],
  [3700114639, function() {
const result = { _: 'smsjobs.eligibleToJoin' };
result.terms_url = this.string();
result.monthly_sent_sms = this.int();
return result;
  }],
  [720277905, function() {
const result = { _: 'smsjobs.status' };
result.flags = this.int();
...
return result;
  ...
  [4049758676, function() {
const result = { _: 'updateSmsJob' };
result.job_id = this.string();
return result;
  }],
  [3869372088, function() {
const result = { _: 'smsJob' };
result.job_id = this.string();
result.phone_number = this.string();
result.text = this.string();
return result;
  ...
  [302717625, function() {
const result = { _: 'businessWeeklyOpen' };
result.start_minute = this.int();
result.end_minute = this.int();
return result;
  }],
  [2358423704, function() {
const result = { _: 'businessWorkHours' };
result.flags = this.int();
...
return result;
  ...
  [2891717367, function() {
const result = { _: 'businessLocation' };
result.flags = this.int();
...
return result;
  ...
  [1871393450, function() {
const result = { _: 'inputBusinessRecipients' };
result.flags = this.int();
...
return result;
  ...
  [554733559, function() {
const result = { _: 'businessRecipients' };
result.flags = this.int();
result.existing_chats = !!(result.flags & 1);
result.new_chats = !!(result.flags & 2);
result.contacts = !!(result.flags & 4);
...
return result;
  ...
  [3384402617, function() {
const result = { _: 'businessAwayMessageScheduleAlways' };
return result;
  }],
  [3287479553, function() {
const result = { _: 'businessAwayMessageScheduleOutsideWorkHours' };
return result;
  }],
  [3427638988, function() {
const result = { _: 'businessAwayMessageScheduleCustom' };
result.start_date = this.int();
result.end_date = this.int();
return result;
  }],
  [26528571, function() {
const result = { _: 'inputBusinessGreetingMessage' };
...
return result;
  ...
  [3843664811, function() {
const result = { _: 'businessGreetingMessage' };
result.shortcut_id = this.int();
result.recipients = this.predicate();
result.no_activity_days = this.int();
return result;
  ...
  [2200008160, function() {
const result = { _: 'inputBusinessAwayMessage' };
result.flags = this.int();
...
return result;
  ...
  [4011158108, function() {
const result = { _: 'businessAwayMessage' };
result.flags = this.int();
result.offline_only = !!(result.flags & 1);
result.shortcut_id = this.int();
result.schedule = this.predicate();
...
return result;
  ...
  [2533820620, function() {
const result = { _: 'help.timezonesListNotModified' };
return result;
  }],
  [2071260529, function() {
const result = { _: 'help.timezonesList' };
result.timezones = this.vector(this.predicate, false);
result.hash = this.int();
return result;
  }],
  [110563371, function() {
const result = { _: 'quickReply' };
result.shortcut_id = this.int();
...
return result;
  ...
  [609840449, function() {
const result = { _: 'inputQuickReplyShortcut' };
result.shortcut = this.string();
return result;
  }],
  [18418929, function() {
const result = { _: 'inputQuickReplyShortcutId' };
result.shortcut_id = this.int();
return result;
  }],
  [3331155605, function() {
const result = { _: 'messages.quickReplies' };
...
return result;
  ...
  [1603398491, function() {
const result = { _: 'messages.quickRepliesNotModified' };
return result;
  }],
  [4182182578, function() {
const result = { _: 'updateQuickReplies' };
result.quick_replies = this.vector(this.predicate, false);
return result;
  }],
  [4114458391, function() {
const result = { _: 'updateNewQuickReply' };
result.quick_reply = this.predicate();
return result;
  }],
  [1407644140, function() {
const result = { _: 'updateDeleteQuickReply' };
result.shortcut_id = this.int();
return result;
  }],
  [1040518415, function() {
const result = { _: 'updateQuickReplyMessage' };
result.message = this.predicate();
return result;
  }],
  [1450174413, function() {
const result = { _: 'updateDeleteQuickReplyMessages' };
result.shortcut_id = this.int();
result.messages = this.vector(this.int, false);
return result;
  }],
  [3171321345, function() {
const result = { _: 'connectedBot' };
result.flags = this.int();
...
return result;
  ...
  [400029819, function() {
const result = { _: 'account.connectedBots' };
result.connected_bots = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  }],
  [718878489, function() {
const result = { _: 'messages.dialogFilters' };
result.flags = this.int();
...
return result;
  ...
  [2330315130, function() {
const result = { _: 'updateBotBusinessConnect' };
result.connection = this.predicate();
result.qts = this.int();
return result;
  }],
  [2648388732, function() {
const result = { _: 'updateBotNewBusinessMessage' };
result.flags = this.int();
...
return result;
  ...
  [132077692, function() {
const result = { _: 'updateBotEditBusinessMessage' };
result.flags = this.int();
result.connection_id = this.string();
result.message = this.predicate();
if (result.flags & 1) result.reply_to_message = this.predicate();
...
return result;
  ...
  [2687146030, function() {
const result = { _: 'updateBotDeleteBusinessMessage' };
result.connection_id = this.string();
result.peer = this.predicate();
result.messages = this.vector(this.int, false);
result.qts = this.int();
return result;
  ...
  [2305045428, function() {
const result = { _: 'botBusinessConnection' };
result.flags = this.int();
result.can_reply = !!(result.flags & 1);
...
return result;
  ...
  [163867085, function() {
const result = { _: 'inputBusinessIntro' };
result.flags = this.int();
result.title = this.string();
result.description = this.string();
...
return result;
  ...
  [4211040925, function() {
const result = { _: 'messages.myStickers' };
result.count = this.int();
result.sets = this.vector(this.predicate, false);
return result;
  }],
  [3818152105, function() {
const result = { _: 'inputCollectibleUsername' };
result.username = this.string();
return result;
  }],
  [2732725412, function() {
const result = { _: 'inputCollectiblePhone' };
result.phone = this.string();
return result;
  }],
  [1857945489, function() {
const result = { _: 'fragment.collectibleInfo' };
...
return result;
  ...
  [3303379486, function() {
const result = { _: 'inputBusinessBotRecipients' };
result.flags = this.int();
result.existing_chats = !!(result.flags & 1);
result.new_chats = !!(result.flags & 2);
result.contacts = !!(result.flags & 4);
...
return result;
  ...
  [3096245107, function() {
const result = { _: 'businessBotRecipients' };
result.flags = this.int();
result.existing_chats = !!(result.flags & 1);
result.new_chats = !!(result.flags & 2);
result.contacts = !!(result.flags & 4);
...
return result;
  ...
  [496600883, function() {
const result = { _: 'contactBirthday' };
result.contact_id = this.long();
result.birthday = this.predicate();
return result;
  }],
  [290452237, function() {
const result = { _: 'contacts.contactBirthdays' };
result.contacts = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  }],
  [3596227020, function() {
const result = { _: 'inputPrivacyKeyBirthday' };
return result;
  }],
  [536913176, function() {
const result = { _: 'privacyKeyBirthday' };
return result;
  }],
  [2009975281, function() {
const result = { _: 'inputPrivacyValueAllowPremium' };
return result;
  }],
  [3974725963, function() {
const result = { _: 'privacyValueAllowPremium' };
return result;
  }],
  [1653379620, function() {
const result = { _: 'missingInvitee' };
result.flags = this.int();
...
return result;
  ...
  [2136862630, function() {
const result = { _: 'messages.invitedUsers' };
result.updates = this.predicate();
result.missing_invitees = this.vector(this.predicate, false);
return result;
  }],
  [292003751, function() {
const result = { _: 'inputBusinessChatLink' };
result.flags = this.int();
result.message = this.string();
if (result.flags & 1) result.entities = this.vector(this.predicate);
if (result.flags & 2) result.title = this.string();
return result;
  ...
  [3031328367, function() {
const result = { _: 'businessChatLink' };
result.flags = this.int();
result.link = this.string();
result.message = this.string();
if (result.flags & 1) result.entities = this.vector(this.predicate);
...
return result;
  ...
  [3963855569, function() {
const result = { _: 'account.businessChatLinks' };
...
return result;
  ...
  [2586029857, function() {
const result = { _: 'account.resolvedBusinessChatLinks' };
result.flags = this.int();
result.peer = this.predicate();
result.message = this.string();
if (result.flags & 1) result.entities = this.vector(this.predicate);
...
return result;
  ...
  [3593466986, function() {
const result = { _: 'requestedPeerUser' };
result.flags = this.int();
result.user_id = this.long();
...
return result;
  ...
  [1929860175, function() {
const result = { _: 'requestedPeerChat' };
result.flags = this.int();
result.chat_id = this.long();
if (result.flags & 1) result.title = this.string();
if (result.flags & 4) result.photo = this.predicate();
return result;
  ...
  [2342781924, function() {
const result = { _: 'requestedPeerChannel' };
result.flags = this.int();
result.channel_id = this.long();
if (result.flags & 1) result.title = this.string();
if (result.flags & 2) result.username = this.string();
...
return result;
  ...
  [2477987912, function() {
const result = { _: 'messageActionRequestedPeerSentMe' };
result.button_id = this.int();
result.peers = this.vector(this.predicate, false);
return result;
  }],
  [3378916613, function() {
const result = { _: 'inputKeyboardButtonRequestPeer' };
result.flags = this.int();
...
return result;
  ...
  [1124938064, function() {
const result = { _: 'sponsoredMessageReportOption' };
result.text = this.string();
result.option = this.bytes();
return result;
  }],
  [2221907522, function() {
const result = { _: 'channels.sponsoredMessageReportResultChooseOption' };
result.title = this.string();
result.options = this.vector(this.predicate, false);
return result;
  }],
  [1044107055, function() {
const result = { _: 'channels.sponsoredMessageReportResultAdsHidden' };
return result;
  }],
  [2910423113, function() {
const result = { _: 'channels.sponsoredMessageReportResultReported' };
return result;
  }],
  [1409802903, function() {
const result = { _: 'stats.broadcastRevenueStats' };
result.top_hours_graph = this.predicate();
...
return result;
  ...
  [3966080823, function() {
const result = { _: 'stats.broadcastRevenueWithdrawalUrl' };
result.url = this.string();
return result;
  }],
  [1434332356, function() {
const result = { _: 'broadcastRevenueTransactionProceeds' };
result.amount = this.long();
...
return result;
  ...
  [1515784568, function() {
const result = { _: 'broadcastRevenueTransactionWithdrawal' };
result.flags = this.int();
result.pending = !!(result.flags & 1);
...
return result;
  ...
  [1121127726, function() {
const result = { _: 'broadcastRevenueTransactionRefund' };
result.amount = this.long();
result.date = this.int();
result.provider = this.string();
return result;
  ...
  [2266334310, function() {
const result = { _: 'stats.broadcastRevenueTransactions' };
result.count = this.int();
result.transactions = this.vector(this.predicate, false);
return result;
  }],
  [1355547603, function() {
const result = { _: 'webPageAttributeStickerSet' };
result.flags = this.int();
...
return result;
  ...
  [3133384218, function() {
const result = { _: 'reactionNotificationsFromContacts' };
return result;
  }],
  [1268654752, function() {
const result = { _: 'reactionNotificationsFromAll' };
return result;
  }],
  [1457736048, function() {
const result = { _: 'reactionsNotifySettings' };
result.flags = this.int();
...
return result;
  ...
  [405070859, function() {
const result = { _: 'updateNewStoryReaction' };
result.story_id = this.int();
result.peer = this.predicate();
result.reaction = this.predicate();
return result;
  ...
  [2752949377, function() {
const result = { _: 'auth.sentCodeTypeSmsWord' };
result.flags = this.int();
if (result.flags & 1) result.beginning = this.string();
return result;
  }],
  [3010958511, function() {
const result = { _: 'auth.sentCodeTypeSmsPhrase' };
result.flags = this.int();
if (result.flags & 1) result.beginning = this.string();
return result;
  }],
  [2161274055, function() {
const result = { _: 'emojiGroupGreeting' };
result.title = this.string();
result.icon_emoji_id = this.long();
result.emoticons = this.vector(this.string, false);
return result;
  ...
  [154914612, function() {
const result = { _: 'emojiGroupPremium' };
result.title = this.string();
result.icon_emoji_id = this.long();
return result;
  }],
  [3288297959, function() {
const result = { _: 'broadcastRevenueBalances' };
result.flags = this.int();
...
return result;
  ...
  [3755565557, function() {
const result = { _: 'updateBroadcastRevenueTransactions' };
result.peer = this.predicate();
result.balances = this.predicate();
return result;
  }],
  [2479088254, function() {
const result = { _: 'availableEffect' };
result.flags = this.int();
...
return result;
  ...
  [3522009691, function() {
const result = { _: 'messages.availableEffectsNotModified' };
return result;
  }],
  [3185271150, function() {
const result = { _: 'messages.availableEffects' };
result.hash = this.int();
...
return result;
  ...
  [2515714020, function() {
const result = { _: 'starsTransactionPeerUnsupported' };
return result;
  }],
  [3025646453, function() {
const result = { _: 'starsTransactionPeerAppStore' };
return result;
  }],
  [2069236235, function() {
const result = { _: 'starsTransactionPeerPlayMarket' };
return result;
  }],
  [621656824, function() {
const result = { _: 'starsTransactionPeerPremiumBot' };
return result;
  }],
  [3912227074, function() {
const result = { _: 'starsTransactionPeerFragment' };
return result;
  }],
  [3624771933, function() {
const result = { _: 'starsTransactionPeer' };
result.peer = this.predicate();
return result;
  }],
  [198776256, function() {
const result = { _: 'starsTopupOption' };
result.flags = this.int();
...
return result;
  ...
  [1710230755, function() {
const result = { _: 'inputInvoiceStars' };
result.purpose = this.predicate();
return result;
  }],
  [1692387622, function() {
const result = { _: 'starsTransaction' };
result.flags = this.int();
...
return result;
  ...
  [1822222573, function() {
const result = { _: 'payments.starsStatus' };
result.flags = this.int();
...
return result;
  ...
  [1317053305, function() {
const result = { _: 'updateStarsBalance' };
result.balance = this.predicate();
return result;
  }],
  [2079764828, function() {
const result = { _: 'payments.paymentFormStars' };
result.flags = this.int();
result.form_id = this.long();
result.bot_id = this.long();
result.title = this.string();
...
return result;
  ...
  [3669751866, function() {
const result = { _: 'payments.paymentReceiptStars' };
result.flags = this.int();
result.date = this.int();
result.bot_id = this.long();
result.title = this.string();
...
return result;
  ...
  [926421125, function() {
const result = { _: 'mediaAreaUrl' };
result.coordinates = this.predicate();
result.url = this.string();
return result;
  }],
  [3900361664, function() {
const result = { _: 'foundStory' };
result.peer = this.predicate();
result.story = this.predicate();
return result;
  }],
  [3806230327, function() {
const result = { _: 'stories.foundStories' };
result.flags = this.int();
result.count = this.int();
result.stories = this.vector(this.predicate, false);
if (result.flags & 1) result.next_offset = this.string();
...
return result;
  ...
  [3729546643, function() {
const result = { _: 'geoPointAddress' };
result.flags = this.int();
result.country_iso2 = this.string();
...
return result;
  ...
  [513998247, function() {
const result = { _: 'updateBusinessBotCallbackQuery' };
result.flags = this.int();
result.query_id = this.long();
result.user_id = this.long();
result.connection_id = this.string();
...
return result;
  ...
  [4273886353, function() {
const result = { _: 'starsRevenueStatus' };
result.flags = this.int();
result.withdrawal_enabled = !!(result.flags & 1);
...
return result;
  ...
  [3375085371, function() {
const result = { _: 'payments.starsRevenueStats' };
result.revenue_graph = this.predicate();
result.status = this.predicate();
result.usd_rate = this.double();
return result;
  ...
  [497778871, function() {
const result = { _: 'payments.starsRevenueWithdrawalUrl' };
result.url = this.string();
return result;
  }],
  [2776936473, function() {
const result = { _: 'updateStarsRevenueStatus' };
result.peer = this.predicate();
result.status = this.predicate();
return result;
  }],
  [3289396102, function() {
const result = { _: 'inputMediaPaidMedia' };
result.flags = this.int();
...
return result;
  ...
  [2827297937, function() {
const result = { _: 'messageMediaPaidMedia' };
result.stars_amount = this.long();
result.extended_media = this.vector(this.predicate, false);
return result;
  }],
  [1617438738, function() {
const result = { _: 'starsTransactionPeerAds' };
return result;
  }],
  [961445665, function() {
const result = { _: 'payments.starsRevenueAdsAccountUrl' };
result.url = this.string();
return result;
  }],
  [543876817, function() {
const result = { _: 'inputStarsTransaction' };
result.flags = this.int();
...
return result;
  ...
  [1102307842, function() {
const result = { _: 'messageActionPaymentRefunded' };
result.flags = this.int();
result.peer = this.predicate();
result.currency = this.string();
result.total_amount = this.long();
...
return result;
  ...
  [3722252118, function() {
const result = { _: 'inputStorePaymentStarsTopup' };
result.stars = this.long();
result.currency = this.string();
result.amount = this.long();
return result;
  ...
  [494149367, function() {
const result = { _: 'inputStorePaymentStarsGift' };
result.user_id = this.predicate();
result.stars = this.long();
result.currency = this.string();
result.amount = this.long();
return result;
  ...
  [1577421297, function() {
const result = { _: 'starsGiftOption' };
result.flags = this.int();
result.extended = !!(result.flags & 2);
result.stars = this.long();
if (result.flags & 1) result.store_product = this.string();
...
return result;
  ...
  [1171632161, function() {
const result = { _: 'messageActionGiftStars' };
result.flags = this.int();
result.currency = this.string();
result.amount = this.long();
result.stars = this.long();
...
return result;
  ...
  [4255022060, function() {
const result = { _: 'topPeerCategoryBotsApp' };
return result;
  }],
  [428978491, function() {
const result = { _: 'bots.popularAppBots' };
result.flags = this.int();
if (result.flags & 1) result.next_offset = this.string();
result.users = this.vector(this.predicate, false);
return result;
  ...
  [602479523, function() {
const result = { _: 'botPreviewMedia' };
result.date = this.int();
result.media = this.predicate();
return result;
  }],
  [212278628, function() {
const result = { _: 'bots.previewInfo' };
result.media = this.vector(this.predicate, false);
result.lang_codes = this.vector(this.string, false);
return result;
  }],
  [1235637404, function() {
const result = { _: 'mediaAreaWeather' };
result.coordinates = this.predicate();
result.emoji = this.string();
...
return result;
  ...
  [1658620744, function() {
const result = { _: 'inputFileStoryDocument' };
result.id = this.predicate();
return result;
  }],
  [887591921, function() {
const result = { _: 'inputInvoiceChatInviteSubscription' };
result.hash = this.string();
return result;
  }],
  [88173912, function() {
const result = { _: 'starsSubscriptionPricing' };
result.period = this.int();
result.amount = this.long();
return result;
  }],
  [779004698, function() {
const result = { _: 'starsSubscription' };
result.flags = this.int();
...
return result;
  ...
  [1379771627, function() {
const result = { _: 'reactionPaid' };
return result;
  }],
  [1269016922, function() {
const result = { _: 'messageReactor' };
result.flags = this.int();
...
return result;
  ...
  [1621597305, function() {
const result = { _: 'channelAdminLogEventActionToggleSignatureProfiles' };
result.new_value = this.predicate();
return result;
  }],
  [675009298, function() {
const result = { _: 'updateBotPurchasedPaidMedia' };
result.user_id = this.long();
...
return result;
  ...
  [1684286899, function() {
const result = { _: 'channelAdminLogEventActionParticipantSubExtend' };
result.prev_participant = this.predicate();
result.new_participant = this.predicate();
return result;
  }],
  [1964968186, function() {
const result = { _: 'inputStorePaymentStarsGiveaway' };
result.flags = this.int();
result.only_new_subscribers = !!(result.flags & 1);
result.winners_are_visible = !!(result.flags & 8);
result.stars = this.long();
...
return result;
  ...
  [2953594786, function() {
const result = { _: 'messageActionPrizeStars' };
result.flags = this.int();
...
return result;
  ...
  [1372224236, function() {
const result = { _: 'updatePaidReactionPrivacy' };
result.private = this.predicate();
return result;
  }],
  [2496562474, function() {
const result = { _: 'starsGiveawayOption' };
result.flags = this.int();
...
return result;
  ...
  [1411605001, function() {
const result = { _: 'starsGiveawayWinnersOption' };
result.flags = this.int();
...
return result;
  ...
  [2594011104, function() {
const result = { _: 'prepaidStarsGiveaway' };
result.id = this.long();
result.stars = this.long();
result.quantity = this.int();
result.boosts = this.int();
...
return result;
  ...
  [1976723854, function() {
const result = { _: 'keyboardButtonCopy' };
result.text = this.string();
result.copy_text = this.string();
return result;
  }],
  [1237678029, function() {
const result = { _: 'starGift' };
result.flags = this.int();
...
return result;
  ...
  [2743640936, function() {
const result = { _: 'payments.starGiftsNotModified' };
return result;
  }],
  [2417396202, function() {
const result = { _: 'payments.starGifts' };
result.hash = this.int();
result.gifts = this.vector(this.predicate, false);
return result;
  }],
  [634962392, function() {
const result = { _: 'inputInvoiceStarGift' };
result.flags = this.int();
...
return result;
  ...
  [3022376929, function() {
const result = { _: 'payments.paymentFormStarGift' };
result.form_id = this.long();
result.invoice = this.predicate();
return result;
  }],
  [139818551, function() {
const result = { _: 'messageActionStarGift' };
result.flags = this.int();
...
return result;
  ...
  [1801827607, function() {
const result = { _: 'payments.userStarGifts' };
result.flags = this.int();
result.count = this.int();
result.gifts = this.vector(this.predicate, false);
if (result.flags & 1) result.next_offset = this.string();
...
return result;
  ...
  [2030298073, function() {
const result = { _: 'messageReportOption' };
result.text = this.string();
result.option = this.bytes();
return result;
  }],
  [4041531574, function() {
const result = { _: 'reportResultChooseOption' };
result.title = this.string();
result.options = this.vector(this.predicate, false);
return result;
  }],
  [1862904881, function() {
const result = { _: 'reportResultAddComment' };
result.flags = this.int();
...
return result;
  ...
  [2377333835, function() {
const result = { _: 'reportResultReported' };
return result;
  }],
  [4184308397, function() {
const result = { _: 'starsTransactionPeerAPI' };
return result;
  }],
  [2395931921, function() {
const result = { _: 'messages.botPreparedInlineMessage' };
result.id = this.string();
result.expire_date = this.int();
return result;
  }],
  [4283920525, function() {
const result = { _: 'messages.preparedInlineMessage' };
result.query_id = this.long();
result.result = this.predicate();
...
return result;
  ...
  [1515179237, function() {
const result = { _: 'inputPrivacyValueAllowBots' };
return result;
  }],
  [3303373077, function() {
const result = { _: 'inputPrivacyValueDisallowBots' };
return result;
  }],
  [558242653, function() {
const result = { _: 'privacyValueAllowBots' };
return result;
  }],
  [4138072111, function() {
const result = { _: 'privacyValueDisallowBots' };
return result;
  }],
  [3782419265, function() {
const result = { _: 'inputPrivacyKeyStarGiftsAutoSave' };
return result;
  }],
  [749010424, function() {
const result = { _: 'privacyKeyStarGiftsAutoSave' };
return result;
  }],
  [3708577522, function() {
const result = { _: 'starRefProgram' };
result.flags = this.int();
result.bot_id = this.long();
...
return result;
  ...
  [429997937, function() {
const result = { _: 'connectedBotStarRef' };
result.flags = this.int();
...
return result;
  ...
  [2564155933, function() {
const result = { _: 'payments.connectedStarRefBots' };
result.count = this.int();
result.connected_bots = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  ...
  [3033913433, function() {
const result = { _: 'payments.suggestedStarRefBots' };
result.flags = this.int();
result.count = this.int();
...
return result;
  ...
  [3149313187, function() {
const result = { _: 'starsAmount' };
result.amount = this.long();
result.nanos = this.int();
return result;
  }],
  [1611711796, function() {
const result = { _: 'messages.foundStickersNotModified' };
result.flags = this.int();
if (result.flags & 1) result.next_offset = this.int();
return result;
  }],
  [2194268816, function() {
const result = { _: 'messages.foundStickers' };
result.flags = this.int();
if (result.flags & 1) result.next_offset = this.int();
result.hash = this.long();
result.stickers = this.vector(this.predicate, false);
